...
literal #000000 -- his ruling, "do option three". Light paints its forced
...
This feature was built once already (PR #142) and reverted (PR #145): it
crashed the service on every start (AGENTS.md's light-mode-fix-import-crash
entry). This rebuild keeps the exact same feature/proof shape but resolves
room_controls lazily everywhere instead of eagerly at construction time --
