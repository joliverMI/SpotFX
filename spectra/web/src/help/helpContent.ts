  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        keywords: 'generator stored preview rhythmic edges bass up down gap stop resume window sensitivity tuning loop transition alignment beat',
        body: [
          ...
          'Two sliders appear next to the tolerance slider whenever a Rhythmic-edges lane is selected in either engine slot: Window (how many consecutive quiet beats count as a real pause, 1–16, default 8) and Sensitivity (how big a bass jump has to be to count, 0.2–1.5, default 0.5). Dragging either recomputes the edges lane and its score live, the same way the tolerance slider does — nothing is written until you push a mark to your real triggers.',
          'Both knobs currently affect only the Rhythmic-edges lane. Turning the edge rule into what the room actually generates — and a "use these as the room\'s own default" button — is separate, later work; for now this page is for tuning by eye and by number before that lands.',
