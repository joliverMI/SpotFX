  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        keywords: 'brightness multiplier dim undim ambient color transition pace global room bar dimmer midsong mid-song trigger fallback scene change mode transitions analysed full settings model force scene hold pin catch-up catchup ease release ramp snap',
        body: [
