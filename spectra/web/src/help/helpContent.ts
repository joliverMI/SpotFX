    ...
    entries: [
      ...
      },
      {
        ...
        body: [
          ...
          'While it\'s on, the panel grows to hold both a searchable list of every colour set/group AND a "Recent" row of the 6 you\'ve pinned here most recently, newest first — a fast re-pick mid-show without typing or scrolling. A recent button and the search box always agree on what\'s pinned; tapping either does the exact same thing. Fewer than 6 recent picks just means fewer buttons.',
