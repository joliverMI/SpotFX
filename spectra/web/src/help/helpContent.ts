    ...
    entries: [
      ...
      },
      {
        ...
        body: [
          ...
          '"Hue areas" (next to the two colour swatches) narrows Ambient to just some of your Hue entertainment areas instead of every live one — see "Ambient Hue areas" below.',
      ...
      },
      {
        ...
        body: [
          'The legacy global Default/Dark/Light display-mode cycle, all three states, on a single "Display" select on the room bar. Hybrid ("default" on the wire — his own word for legacy\'s Default) forces nothing: each device shows whatever its scene authors. Dark hard-clamps every non-shielded device\'s background to black at LedFX itself (the same dark_lock flag the legacy toggle drove) — no write path, drift glide, or scene fire can relight a background while it\'s set. Light forces the colour/brightness picker next to the select onto every non-shielded device\'s background, live, right now, whether or not music is playing — see "Light mode — forced background" below.',
          ...
          'A red badge next to the select names any device that didn\'t confirm the requested state (dark_lock, or the Light background) after a live read-back from LedFX — checked, never assumed.',
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          'The "Hue areas" button next to Ambient\'s colour swatches. By default Ambient reaches EVERY live Hue entertainment area in the room — this picker lets you narrow that to just the ones you want, e.g. your dining room versus your other Hue lights, if you have more than one Hue bridge/area.',
