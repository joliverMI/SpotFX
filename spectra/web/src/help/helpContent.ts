    ...
    entries: [
      ...
      },
      {
        ...
        body: [
          ...
          'Fireworks: charge — launch rate climbs 6× while bursts shrink and slow; lull — launching stops, six dim rockets cross the dark panel from evenly spaced points around the rim (about 60° apart, each nudged a little so the ring is not mechanical), travelling about twice as far past centre as before exploding; drop — every rocket explodes where it is, giant, in its own colour.',
