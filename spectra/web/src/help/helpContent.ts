  ...
  /* ── Timing & Debug (ported from spot-effects, same pages) ─────── */
  {
    ...
    entries: [
      ...
      },
      {
        ...
        keywords: 'drift alarm audio chain latency session offset moved snapclient common shift level step ramp stable reversal anchor',
        body: [
