    ...
    entries: [
      ...
      },
      {
        ...
        body: [
          ...
          '"Room\'s current default" shows what the room is actually using right now for Window/Sensitivity/Transitions-per-song, and is highlighted whenever the sliders above no longer match it. "Use as room default" writes the three sliders as the room\'s new defaults — the same fields shown on the room controls bar\'s "Transition placement rule" section — after a confirmation naming the exact values; dragging a slider never writes anything by itself, only pressing this button does.',
