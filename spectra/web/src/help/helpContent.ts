  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        keywords: 'sequencer curve likelihood dwell affinity genre profile inline one-off detach revert save named overwrite grid thumbnail picker preview button window scroll',
        body: [
