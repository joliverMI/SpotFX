    ...
    entries: [
      ...
      },
      {
        ...
        body: [
          ...
          'Since the edge-then-downbeat rule became the room\'s own placement rule (see "Transition placement rule" on the room controls bar), Generator: Preview reflects it too: it shows exactly what "⟳ Generate" would produce right now at whatever Window/Sensitivity/Direction you have dragged here — the room\'s own snap-to-beat toggle and "Transitions per song" density cap still apply at their live room-setting values, since neither of those has a test-bed-only copy. A "use these as the room\'s own default" button for Window/Sensitivity is separate, later work.',
