    ...
    entries: [
      ...
      },
      {
        ...
        body: [
          ...
          'Pause GENUINELY drops the connection to LedFX — not just a blank display. Resume reopens it. This choice is sticky: it\'s saved, so it survives a SPECTRA restart, and it stays paused until you click Resume — it never un-pauses itself.',
          ...
          'The badge always tells you which of the four states you\'re in, so you can tell at a glance why nothing\'s streaming: "live" (subscribed, showing real colour); "paused" (gray — you clicked Pause; stays this way until you click Resume); "idle — tab hidden" (blue — this tab isn\'t visible right now; it\'ll pick back up on its own the moment you switch to it); "reconnecting…" (amber — LedFX itself is unreachable; the preview never restarts or wakes it, it just waits and retries). Your own Pause always takes priority in the badge — pausing manually and then switching tabs still reads "paused," not "idle."',
