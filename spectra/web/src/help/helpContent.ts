  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        keywords: 'map run sync dark black white settle capture seconds held restore revert abandon refuse exposure unseen no light seen pose missing summary brightness dim turned down bri firmware weight faint',
        body: [
