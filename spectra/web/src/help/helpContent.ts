  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        keywords: 'transition time crossfade intensity scale linear gentle hard low high min max lead early midpoint mid-point mid point land on the trigger beat momentary flare first switch finish hold flip back inspector settings scene transition',
        body: [
