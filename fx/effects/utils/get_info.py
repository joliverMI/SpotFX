...
async def fetch_info(session, ip_address, callback):
    ...
    # SpotFX deviation: aiohttp import moved inside (was module-scope). aiohttp
    # is the dropped LedFX web stack's client lib and is not a SpotFX
    # dependency; this diagnostics helper only runs in logsec diag mode.
    import aiohttp
...
async def _start_request(ip_address, callback):
    ...
    import aiohttp  # SpotFX deviation: see fetch_info
