...
import fx.effects.mel as mel
from fx.effects import fast_blur_array
from fx.effects.math import ExpFilter
from fx.events import GraphUpdateEvent
...
class Melbank:
    ...
    def __call__(self, frequency_domain, filter_banks, filter_banks_filtered):
        ...
        # The auto-gain trends to ~0 during silence; dividing by it on a
        # silence->spike transition would mint inf/NaN that then latches into
        # the smoothing/common/diff filters below. Floor the divisor.
        gain = self.mel_gain.value
