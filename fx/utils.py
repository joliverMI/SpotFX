...
from fx.color import LEDFX_GRADIENTS
from fx.config import save_config
from fx.consts import LEDFX_ASSETS_PATH, PROJECT_VERSION
from fx.events import ColorsUpdatedEvent
from fx.libraries.cache import ImageCache
from fx.utilities.security_utils import (
    DOWNLOAD_TIMEOUT,
...
class Graph:
    ...
    def dump_graph(self, sub_title=None, jitter=False, only_jitter=False):
        ...
        try:
            ...
            from fx.config import get_default_config_directory
        except ImportError:
